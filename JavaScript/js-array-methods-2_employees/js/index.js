...
function findByLastName(employees, lastName) {
   const result= employees.find((obj) => obj.lastName ===lastName);
...
function findById(employees, id) {
  const result= employees.find((obj) => obj.id ===id);
   return result;
}
...
function findByCitySubString(employees, string) {
  const result= employees.find((obj) => obj.city.includes(string));
...
//   const profession= employees.find((obj) => obj.profession.includes(string))
//   const searchAge= employees.find((obj) => obj.age ==age);
// console.log(profession)
//console.log(searchAge)

 
     if(employees.find((obj) => obj.profession.includes(string)) && employees.find((obj) => obj.age ===age)){
     const result=true;
     console.log(result)
    return result;
     }else {
